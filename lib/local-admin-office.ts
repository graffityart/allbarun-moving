...
import { chungnamAdminOffices } from "@/lib/local-admin-office-chungnam";
...
const overrides:Record<string,LocalAdminOffice>={...jeonbukAdminOffices,...jeonnamAdminOffices,...gyeongbukAdminOffices,...gangwonAdminOffices,...gangwonNorthAdminOffices,...gangwonEastAdminOffices,...gangwonCoastAdminOffices,...chungbukAdminOffices,...chungnamAdminOffices};
