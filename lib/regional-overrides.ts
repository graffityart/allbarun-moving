...
export function getRegionalOverride(region:string,district:string):LocalGuide|undefined{return getBusanPriorityGuide(region,district)??getBusanExpandedGuide(region,district)??getGyeonggiPriorityGuide(region,district)??overrides[region]?.[district]??getRegionalOverrideExtra(region,district)??getRegionalOverrideThird(region,district)??getRegionalOverrideExtra3(region,district)??getChungbukExtraGuide(region,district)??getGangwonExtraGuide(region,district)??getJeonbukExtraGuide(region,district)??getJeonnamExtraGuide(region,district)??getGyeongbukExtraGuide(region,district)??getPriorityRegionalGuide(region,district)??getRuralBatch2Guide(region,district);}
