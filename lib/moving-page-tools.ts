...
const seoulNearby:Record<string,string[]>={
 "강남구":["서초구","송파구","광진구","성동구"],
 "강동구":["송파구","광진구"],
 "강북구":["도봉구","노원구","성북구"],
 "강서구":["양천구","마포구","영등포구"],
 ...
 "성북구":["강북구","노원구","동대문구","종로구"],
 "송파구":["강남구","강동구","광진구"],
 "양천구":["강서구","구로구","영등포구"],
 "영등포구":["양천구","구로구","동작구","마포구","용산구"],
 "용산구":["마포구","중구","성동구","서초구","동작구","영등포구"],
 "은평구":["서대문구","마포구","종로구"],
 "종로구":["서대문구","은평구","성북구","동대문구","중구"],
 "중구":["종로구","서대문구","성동구","용산구"],
 "중랑구":["노원구","동대문구","광진구"]
};
...
export function getNearbyDistricts(slug:string,district:string,limit=6){
 ...
 if(!region)return[];
 if(slug==="seoul"){
  const mapped=(seoulNearby[district]??[]).filter(d=>region.districts.includes(d));
