...
const siteUrl=(process.env.NEXT_PUBLIC_SITE_URL||"https://olbarun.kr").replace(/\/$/,"");
export const metadata:Metadata={metadataBase:new URL(siteUrl),title:{default:"올바른이사 | 전국 이사업체 비교견적",template:"%s | 올바른이사"},description:"포장이사, 원룸이사, 일반이사, 사무실이사를 지역별 특성과 함께 비교하고 손없는날, 날씨, 전입신고, 생활요금 이전 등 실제 이사 준비 정보를 확인하세요.",applicationName:"올바른이사",category:"이사 비교견적",robots:{index:true,follow:true},alternates:{canonical:"/"},openGraph:{title:"올바른이사 | 전국 이사업체 비교견적",description:"지역별 이사 조건과 손없는날·날씨, 생활정보까지 함께 확인하고 이사업체 견적을 비교하세요.",url:siteUrl,type:"website",locale:"ko_KR",siteName:"올바른이사"},twitter:{card:"summary_large_image",title:"올바른이사 | 전국 이사업체 비교견적",description:"지역별 이사 조건과 손없는날·날씨, 생활정보를 확인하고 이사업체 견적을 비교하세요."}};
