...
function makeProvinceMeta(region:(typeof regionProfiles)[number]){
 const title=`${region.name} 포장이사·이사업체 | 시·군·구별 이사정보`;
 const description=`${region.summary} ${region.housing} ${region.districts.length}개 시·군·구별 차량 접근과 포장이사 견적 비교사항을 확인하세요.`;
